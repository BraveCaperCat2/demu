...
summon text_display 56.528 133 118.476 {Tags:["dem_core_display"],text:'\ueeda',see_through:0b,background:0,alignment:"center",transformation:{left_rotation:[0f,0f,0f,1f],scale:[1.8f,1.8f,1.8f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0.06f]},interpolation_duration:2}
