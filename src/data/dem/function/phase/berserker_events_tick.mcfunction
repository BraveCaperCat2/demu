...
execute if score #dem dem.phase_timer matches 800..800 run function dem:broadcast {"text":"{\"text\":\"Stabilizer D-W Coil #1 Damage Detected!\",\"color\":\"#ffD090\"}", "level":0}
...
execute if score #dem dem.phase_timer matches 1200..1200 run function dem:broadcast {"text":"{\"text\":\"Power laser N_D- Vitals damage detected!\",\"color\":\"#ffD090\"}", "level":0}
...
execute if score #dem dem.phase_timer matches 1600..1600 run function dem:broadcast {"text":"{\"text\":\"Power laser S_U- Coil damage detected!\",\"color\":\"#ffD090\"}", "level":0}
...
execute if score #dem dem.phase_timer matches 2000..2000 run function dem:broadcast {"text":"{\"text\":\"Energy Collector D-NE damage detected!\",\"color\":\"#ffD090\"}", "level":0}
...
execute if score #dem dem.phase_timer matches 2400..2400 run function dem:broadcast {"text":"{\"text\":\"Horizon Scrubber temperatures exceeding safe operating parameters\",\"color\":\"#ff4040\"}", "level":0}
...
execute if score #dem dem.phase_timer matches 2800..2800 run function dem:broadcast {"text":"{\"text\":\"Power laser E_U- Coil damage detected!\",\"color\":\"#ffD090\"}", "level":0}
...
execute if score #dem dem.phase_timer matches 3200..3200 run function dem:broadcast {"text":"{\"text\":\"Gravitational shielding critical stress detected!\",\"color\":\"#ff4040\"}", "level":0}
...
execute if score #dem dem.phase_timer matches 3600..3600 run function dem:broadcast {"text":"{\"text\":\"Stabilizer U-N Rotor #1 Damage Critical!\",\"color\":\"#ffD090\"}", "level":0}
...
execute if score #dem dem.phase_timer matches 4000..4000 run function dem:broadcast {"text":"{\"text\":\"Power laser W_D- Vitals damage detected!\",\"color\":\"#ffD090\"}", "level":0}
...
execute if score #dem dem.phase_timer matches 4400..4400 run function dem:broadcast {"text":"{\"text\":\"Electromagnetic flux control failure detected.\",\"color\":\"#ffD090\"}", "level":0}
...
execute if score #dem dem.phase_timer matches 4800..4800 run function dem:broadcast {"text":"{\"text\":\"Power laser S_D- Coil damage detected!\",\"color\":\"#ffD090\"}", "level":0}
...
execute if score #dem dem.phase_timer matches 5200..5200 run function dem:broadcast {"text":"{\"text\":\"Energy Collector U-NW damage detected!\",\"color\":\"#ffD090\"}", "level":0}
...
execute if score #dem dem.phase_timer matches 5600..5600 run function dem:broadcast {"text":"{\"text\":\"Horizon Scrubber temperatures critical!\",\"color\":\"#ff4040\"}", "level":0}
...
execute if score #dem dem.phase_timer matches 6000..6000 run function dem:broadcast {"text":"{\"text\":\"Stabilizer D-E Coil #3 Damage Detected!\",\"color\":\"#ffD090\"}", "level":0}
...
execute if score #dem dem.phase_timer matches 6400..6400 run function dem:broadcast {"text":"{\"text\":\"Multiple critical faults detected in Horizon Scrubber components.\",\"color\":\"#ffD090\"}", "level":0}
...
execute if score #dem dem.phase_timer matches 6800..6800 run function dem:broadcast {"text":"{\"text\":\"Power laser E_D- Coil damage detected!\",\"color\":\"#ffD090\"}", "level":0}
...
execute if score #dem dem.phase_timer matches 7200..7200 run function dem:broadcast {"text":"{\"text\":\"Gravitational shielding data unavailable: Critical sensor array failure.\",\"color\":\"#ffD090\"}", "level":0}
...
execute if score #dem dem.phase_timer matches 7600..7600 run function dem:broadcast {"text":"{\"text\":\"Reactor chamber experiencing extreme gravitational fluctuations.\",\"color\":\"#ffD090\"}", "level":0}
