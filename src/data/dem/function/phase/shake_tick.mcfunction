...
execute if score #dem dem.phase matches 1 if score #dem dem.phase_timer matches 1.. step 2 as @a at @s run tp @s ~ ~ ~ ~0.30 ~0.15

# Even ticks: small negative jitter
execute if score #dem dem.phase matches 1 if score #dem dem.phase_timer matches 0.. step 2 as @a at @s run tp @s ~ ~ ~ ~-0.30 ~-0.15
